...
entry_ok=1
for required in playbook.yml SKILL.md CONTRACT.md scripts/invoke.py scripts/control.py scripts/config.py references/settings.md references/operation-contract.md references/activation.md references/parallel-work.md references/secret-handling.md references/dependency-updates.md assets/policy.example.yml; do
